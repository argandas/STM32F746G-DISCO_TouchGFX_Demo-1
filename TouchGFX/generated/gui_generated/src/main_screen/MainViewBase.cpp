    ...
    flexButtonCallback(this, &MainViewBase::flexButtonCallbackHandler)
{
    ...
    toggleButton.setPosition(348, 60, 100, 56);
    ...
    touchButton.setPosition(32, 61, 100, 45);
    ...
    zeroButton.setPosition(32, 110, 100, 56);
    ...
    repeatButton.setPosition(32, 166, 100, 45);
    ...
    ledButton.setPosition(348, 156, 100, 56);
